...
from linked_lists.doubly_ll.ll import DoublyLinkedList
from linked_lists.doubly_ll.ll import Node


class TestDoublyLinkedList(unittest.TestCase):
    def verify_none(self, ll: DoublyLinkedList):
    ...
    def fill_data(self, ll: DoublyLinkedList, fill_size=25):
        pushedElements = []
